...
do
 {
	...
	$appleRajoitusID = (Invoke-MgGraphRequest -method get -uri "https://graph.microsoft.com/v1.0/deviceManagement/deviceEnrollmentConfigurations?`$filter=displayName eq 'macOS kielletty'" -OutputType PSOBject).value.id
    $appleRajoitusnimi = (Invoke-MgGraphRequest -method get -uri https://graph.microsoft.com/beta/deviceManagement/deviceEnrollmentConfigurations/$appleRajoitusID).displayname
    ...
    $appleRajoitusTyyppi = (Invoke-MgGraphRequest -method get -uri https://graph.microsoft.com/beta/deviceManagement/deviceEnrollmentConfigurations/$appleRajoitusID).platformType
    ...
    $androidRajoitus = (Invoke-MgGraphRequest -method get -uri "https://graph.microsoft.com/beta/deviceManagement/deviceEnrollmentConfigurations?`$filter=displayName eq 'AllowAndroid'" -OutputType PSOBject | Select-Object -ExpandProperty value).platformRestriction.platformBlocked | Select-Object -First 1
