...
do
 {
   ...
   '1' {
    ...
    $FirefoxAsennusGPO = Select-String -path C:\FirefoxAsennus.xml -Pattern 'Name>Mozilla Firefox' -SimpleMatch -Context 0, 12 | Out-String -Stream | Select-String -Pattern "AutoInstall>false<"
